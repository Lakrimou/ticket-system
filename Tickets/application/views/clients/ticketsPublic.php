<div class="content">
    <div class="page-title-cont clearfix">
        <h3>Les Tickets publiques</h3>
    </div>
    <?php foreach($ticketsPublique as $key) { ?>
                ...
                ">
                    <div class="cont">
                        ...
                        <div style="display: inline-block; margin-left: 270px;">
                            <?php echo '<span class="glyphicon glyphicon-time " aria-hidden="true"></span>&nbsp<strong>Date de création </strong>&nbsp'.$key['date_ticket'].'&nbsp &nbsp <span class="glyphicon glyphicon-eye-open " aria-hidden="true"></span>&nbsp<strong>Visibilité </strong>&nbsp'.$key['visibility'].': publique';?>
                        </div>
                </a>
            </div>
        </div>
