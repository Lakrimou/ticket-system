<div class="content">
	<div id="content" class="container">
      <div class="page-title-cont clearfix">
		...
		<?php echo form_open("userAdmin/resultatsolution", array('class' => 'form-horizontal'));?>
...
<script type="text/javascript">
            $('document').ready(function() {
                  $( "#body" ).autocomplete({
                    source: "<?php echo base_url('userAdmin/get_ticketts/?');?>",
...
function lookup(inputString) {
    if(inputString.length == 0) {
        ...
        $.post("<?php// echo base_url('userAdmin/autocomplete');?>", {queryString: ""+inputString+""}, function(data){
            if(data.length > 0) {
                $('#suggestions').show();
