				...
				<div class="row min-bottom-margin">
					<div class="col col-xs-12">
						<div class="cont">
							...
							<div style="display: inline-block;">
								...
								if($conversation) {								
									foreach ($conversation as $key) {?>
										<img src="<?php echo base_url('assets/images/avatar.PNG');?>" style="display: inline-block;">
										<?php echo '<div class="tick-response" style="display: inline-block;">'.$key['body'].'</div><br/>'; 
									}
								}else {
									echo ' ';
								}
							...
							<?php echo form_open("operatorHome/accueilOperator", array('class' => 'form-horizontal'));?>
