            ...
            if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
            {
               ...
               // if($user)
                ...
                foreach ($role as $key) {
                    if($key->group_id == 1)
                    {
                        redirect('/homeAdmin/index', 'refresh');
                    }
                    elseif ($key->group_id == 2) {
                        redirect('/userAdmin/index', 'refresh');
                    }
                    else {
...
1- Récupérez l'id du user IDUSER
2- Appeler le model userModel->getUserRole(IDUSER)

userModel->getUserRole(IDUSER) fait une requéte sur la table users_groups et récupére la valeur du champs group_id donc :

is group_id == 1 => Admin redirect('/homeAdmin/index', 'refresh');
sinon si group_id == 2 => Operateur redirect('/homeOperateur/index', 'refresh');
sinon ==> Client redirect('/homeClient/index', 'refresh');
...
*/
    ...
    function create_user()
    {
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data))
        {
            ...
            $this->session->set_flashdata('message', $this->ion_auth->messages());
            //$this->ddon['title']= "Liste des utilisateurs"
            redirect("auth", 'refresh');
        }
        else
        {
            ...
            $this->data['title'] = "Gestion des utilisateurs";
